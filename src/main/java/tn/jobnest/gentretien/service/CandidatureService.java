...
public class CandidatureService {
    ...
    public List<Document> getDocumentsByCandidature(int idCandidature) {
        ...
        String sql = "SELECT id_document, id_candidature, nom_document, type_document, chemin_fichier, date_upload " +
    ...
    /**
     * Vérifie si un candidat (par son id_user) est participant
     * dans au moins un entretien en base de données.
     * Utilisé dans l'historique des candidatures pour afficher
     * le badge "Avec entretien" ou "Sans entretien".
     */
